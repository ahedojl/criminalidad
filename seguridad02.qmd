...
```{r}
#| label: fig-graf_tasa_th_seguridad02
#| echo: false
#| fig-cap: Tasa `Salud pública - Tráfico de drogas (UE)` en los TTHH.
#| fig-subcap: 
#|    - "Año 2024"
#|    - "Año 2025"
#| layout-ncol: 2
...
```{r}
#| label: fig-graf_variacion_th_seguridad02
#| echo: false
#| fig-cap: Variación `Salud pública - Tráfico de drogas (UE)` en los TTHH.

graf_variacion_th_seguridad02
```
...
```{r}
#| label: fig-graf_tasa_capitales_seguridad02
#| echo: false
#| fig-cap: Tasa `Salud pública - Tráfico de drogas (UE)` en las capitales vascas.
#| fig-subcap: 
#|    - "Año 2024"
#|    - "Año 2025"
#| layout-ncol: 2

graf_tasa_capitales_seguridad02_24
graf_tasa_capitales_seguridad02_25
```

## Variación año 24-25

```{r}
#| label: fig-graf_variacion_capitales_seguridad02
#| echo: false
#| fig-cap: Variación `Salud pública - Tráfico de drogas (UE)` en las capitales vascas.

graf_variacion_capitales_seguridad02
```
...
```{r}
#| label: fig-graf_tasa_mun_seguridad02
#| echo: false
#| fig-cap: Tasa `Salud pública - Tráfico de drogas (UE)` en los municipios vascos.
#| fig-subcap: 
#|    - "Año 2024"
#|    - "Año 2025"
#| layout-ncol: 2
...
graf_tasa_mun_seguridad02_24
graf_tasa_mun_seguridad02_25
```

## Variación año 24-25

```{r}
#| label: fig-graf_variacion_mun_seguridad02
#| echo: false
#| fig-cap: Variación `Salud pública - Tráfico de drogas (UE)` en los municipios vascos.
#| fig-height: 12
#| fig-width: 12

graf_variacion_mun_seguridad02
```
